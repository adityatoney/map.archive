# Claude Code Prompt: Medical Analytics Platform — E2E Cloud Application

## Role & Context

You are building a full-stack, cloud-hosted medical analytics platform called **Medical Analytics Platform**. This application ingests frequency-based body scan reports, runs them through an NLP-powered pattern recognition pipeline, and presents diagnostic insights with recovery plan recommendations through an interactive dashboard.
